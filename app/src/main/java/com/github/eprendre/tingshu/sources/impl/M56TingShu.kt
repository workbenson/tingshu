...
object M56TingShu : TingShu {
    override fun getCategoryMenus(): List<CategoryMenu> {
        val menu1 = CategoryMenu("有声小说", R.drawable.ic_library_books, View.generateViewId(), listOf(
        ...
        val menu2 = CategoryMenu("评书", R.drawable.ic_radio_black_24dp, View.generateViewId(), listOf(
        ...
        val menu3 = CategoryMenu("其它", R.drawable.ic_more_horiz, View.generateViewId(), listOf(
